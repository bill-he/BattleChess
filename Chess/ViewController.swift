...
class ViewController: NSViewController{
    ...
    @IBAction func switchButtonClicked(_ button: NSButton){
    ...
    @IBAction func iconSetPopUpAction(_ popUpButton: NSPopUpButton){
        ...
        iconSetPreviewImageView.image = NSImage(named: "\((popUpButton.selectedItem?.title.lowercased())!)_preview")
    }
    ...
    @IBAction func startButtonClicked(_ button: NSButton){
